...
import { ColorsActions, ColorsProps, ColorsState } from "@hexerals/hexlib"
        ...
        return (
            ...
            >
                {this.props.colors.driftColors.map((driftColor, i) => {
                    ...
                    const textStyle = {
                        fill: driftColor.contrast().hexString,
                    }
                    return (
                        <g
                        ...
                        >
                            <polygon style={wedgeStyle} points={points} />
                            <text
                                className="debug"
                                style={textStyle}
                                x={textX}
                                ...
                                transform={
                                    ...
                                    ` translate(0 0.043)`
                                } // center vertically in wedge
                            >
                                {driftColor.cie.lchString}
                            </text>
                        </g>
                    )
                })}
                <g className="addColor">
                    <circle r={1 / 2.5} onClick={this.props.onAddColor} />
                    <text x="0" y="0.13" onClick={this.props.onAddColor}>
                        +
                    </text>
                    <text
                        className="debug"
