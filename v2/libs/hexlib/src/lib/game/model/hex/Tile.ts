...
export class Tile {
    static readonly EMPTY: Tile = new Tile(Player.Nobody, 0, Terrain.Empty)
    static readonly MOUNTAIN = new Tile(Player.Nobody, 0, Terrain.Mountain)
    static readonly CITY = new Tile(Player.Nobody, 0, Terrain.City)
    ...
    static readonly MAYBE_CITY = new Tile(Player.Nobody, 0, Terrain.City, false)
    ...
    equals(that: unknown) {
        return (
            that !== undefined &&
            this.owner === (that as Tile).owner &&
            this.pop === (that as Tile).pop &&
            this.terrain === (that as Tile).terrain &&
            this.known === (that as Tile).known
        )
    }
}
